...
def build():
    ...
    for t in range(0, nu*N, nu): # LOOP OVER TIME STEPS
        ...
        for i in range(0, Nobs*nobs, nobs): # LOOP OVER ALL OBSTACLES
            ...
            for j in range(0,nedges): # LOOP OVER ALL EDGES IN OBSTACLE i

                psi = z0[nz+i+2+nedges+j] # distance for current edge
